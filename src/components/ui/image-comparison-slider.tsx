        ...
        return (
            ...
            >
                ...
                >
                    ...
                    <div
                        className={cn(
                            "absolute top-1/2 -translate-y-1/2 -translate-x-1/2 h-12 w-12 flex items-center justify-center rounded-full bg-white/50 text-[#1A1560] shadow-xl backdrop-blur-md",
                            "transition-all duration-300 ease-in-out",
                            "group-hover:scale-105",
                            isDragging && "scale-105 shadow-2xl shadow-indigo-500/50"
                        )}
                        role="slider"
                    ...
                    >
                        <div className="flex items-center text-[#1A1560]">
